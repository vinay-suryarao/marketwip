...
import ResultsManagerForm from "@/components/admin/ResultsManagerForm";
          ...
          <div className="relative z-10 flex flex-wrap items-center justify-between gap-4">
            <div>
              <h1 className="bg-linear-to-r from-[#102550] to-[#2d86cc] bg-clip-text text-3xl font-extrabold font-display text-transparent sm:text-4xl">
                Company Results Manager
              </h1>
              <p className="mt-2 text-sm font-medium text-[#6074a0]">
                Add, update, or delete company-wise result tables. Changes reflect instantly on public Result page.
              </p>
            </div>
