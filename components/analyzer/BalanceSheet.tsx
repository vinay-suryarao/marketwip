...
export default function BalanceSheet({ rows }: Props) {
  ...
  return (
    <section className="rounded-3xl border border-[#d8e2f5] bg-linear-to-b from-[#ffffff] to-[#f8fbff] p-6 shadow-[0_12px_28px_rgba(24,58,120,0.1)] sm:p-8">
      <div className="mb-4 border-b border-[#d8e2f5] pb-4">
        <p className="text-xs font-bold uppercase tracking-[0.14em] text-[#5f77a5]">Assets &amp; Liabilities</p>
        <h2 className="mt-1 text-xl font-extrabold text-[#173462] sm:text-2xl">Balance Sheet</h2>
      </div>
